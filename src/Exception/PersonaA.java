...
public class PersonaA {
	...
	public PersonaA(Double altezza, String cognome, String nome, Float peso, String dataDiNascita, String email, String password) throws Exception {
    	setAltezza(altezza);
    	setCognome(cognome);
    	setNome(nome);
    	setPeso(peso);
	...
	public PersonaA(PersonaA persona) throws Exception {
    	if (persona != null) {
	...
	public void setDataDiNascita(String dataDiNascita) throws Exception {
    	if (dataDiNascita != null) {
        	...
        	if (dataDiNascita.length() != 10) {
                ...
                if(DataEasy.differenzaInGiorni(d, d1) < 0){
