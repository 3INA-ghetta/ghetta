...
public class PersonaA {
    ...
    public PersonaA(Double altezza, String cognome, String nome, Float peso, String dataDiNascita, String email,
    ...
    public PersonaA(PersonaA p) throws Exception {
    ...
    public Boolean verificaOmonimia(PersonaA persona) throws Exception {
        Boolean is = false;
    ...
    public static void main(String[] args) throws Exception {
        try {
            PersonaA persona8A1 = new PersonaA();
            PersonaA persona8A2 = new PersonaA(1.95, "Rossi", "Mario", 75.5f, "24/01/2025", "as@cd.it", "Pass123!");

            System.out.println("PersonaA1: \n" + persona8A1.info() + "\n");
            System.out.println("PersonaA2: \n" + persona8A2.info());
